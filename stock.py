...
#For Stock Data
from iexfinance import yahoo_finance
...
def sendMessage(text):
    ...
    username = "asuhashini2000@gmail.com"
    password = "suha@123"

    vtext = "9566018339@airtelkk.com"
    message = text
...
def predictData(stock, days):
    ...
    df = yahoo_finance(stock, start=start, end=end, output_format='pandas')
